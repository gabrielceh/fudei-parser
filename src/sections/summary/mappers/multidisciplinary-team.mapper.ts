...
} from '../models/multidisciplinary-team.model';
...
export class MultidisciplinaryTeamMapper {
  static map(text: string): MultidisciplinaryTeam | undefined {
    const chunkMultidisciplinaryTeam = extractSectionByTitle({
      text: text,
      startTitle:
        'Antecedentes de Identificación del Equipo Multidisciplinario que realizó la Evaluación Diagnóstica\\s*Integral',
